...
// Function to process nested object and add 2033 data + remove 2020 data
...
console.log('✓ value.json updated: removed 2020, added 2033');
...
console.log('✓ volume.json updated: removed 2020, added 2033');

console.log('\n✅ All files updated successfully!');
console.log('Year range is now: 2021 - 2033');
