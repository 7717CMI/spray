...
export function EnhancedFilterPanel() {
  ...
  // Clean up the hierarchy to ensure proper nesting
  ...
  if (Object.keys(hierarchy).length > 0) {
    ...
    const businessTypeRoot = (hasB2BSegmentation && (filters.businessType === 'B2B' || filters.businessType === 'B2C'))
      ...
      <div>
        ...
        <div className="flex gap-1 mt-1">
          <button
            ...
            className="flex-1 px-3 py-1.5 text-sm rounded bg-blue-600 text-white cursor-default"
            disabled
          >
            Value
          </button>
